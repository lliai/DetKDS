...
def main():
    ...
    parser.add_argument('result', 
                        default="/root/datasets/byf/code/MGD-I/results/.bbox.json", 
                        help='result file (json format) path')
    parser.add_argument('out_dir', 
                        default="./coco_error_analysis/",
                        help='dir to save analyze result images')
    parser.add_argument(
        '--ann',
        default='/mnt/paas/kubernetes/kubelet/datasets/byf/datasets/coco/annotations/instances_val2017.json',
